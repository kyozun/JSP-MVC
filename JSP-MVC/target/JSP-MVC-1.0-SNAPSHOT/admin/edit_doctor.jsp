                ...
                <div class="card-body">
                    ...
                    <form action="../updateDoctor" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="dateOfBirth" type="date" placeholder="Enter DOB" class="form-control" value="<%=doctor.getDateOfBirth()%>">
                        </div>
                        <div class="mb-3">
...
<%--                            %>--%>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="phone" type="text" placeholder="Enter mobile number" class="form-control" value="<%=doctor.getPhone()%>">
                        </div>
                        <div class="mb-3">
